...
namespace Krzyzowka.Migrations
{
    ...
    [Migration("20230125124734_crossword_name")]
    partial class crossword_name
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krzyzowka.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Krzyzowka.Models.Crossword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krzyzowka.Models.CrosswordSave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CrosswordSaves");
                });

            modelBuilder.Entity("Krzyzowka.Models.GuessWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krzyzowka.Models.CrosswordSave", b =>
                {
                    b.HasOne("Krzyzowka.Models.Crossword", "crossword")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Krzyzowka.Models.ApplicationUser", null)
                        .WithMany()
